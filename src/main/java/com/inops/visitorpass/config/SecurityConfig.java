...
@Configuration
@EnableWebSecurity
@ComponentScan(basePackages = "com.inops.visitorpass")
public class SecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		// http.authorizeRequests().antMatchers("**/send-whatsapp","/api/register","/javax.faces.resource/**")
		...
		http.authorizeRequests().antMatchers("/send-whatsapp", "/webhook", "/javax.faces.resource/**").permitAll()
